...
\todo[inline]{Again, an example would be great. I don't think at this point the reader understands why/when a designer would use "Anything"}
...
\todo[inline]{It is not easy for the reader to understand "Vice versa for model reuse". I would write another sentence explaining that, for model reuse, the mapping is the inverse, i.e., the stub is in model 2, and start and end points from model 1 are mapped to it.}
