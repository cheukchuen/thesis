...
\todo[inline]{I think it is confusing that the names of the responsibilities are so similar in both models. Maybe call them BTask1 instead of Task1 (B)?}
\todo[inline]{The following paragraph should go into chapter 3. You can also repeat it here, but maybe at the beginning of the model extension section?}
...
\todo[inline]{In the model for the base Authentication feature, there should not be any handling of blocking, i.e., in case of authentication failure, there should be no or-fork that either allows the user to retry or block the account.}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=1.25]{fig_4_11.png}
